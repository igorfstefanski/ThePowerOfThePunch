...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void XRUIInputModule_OnEnable_mB938D9A55AF66EDC8A3384F357ADAEC6B3EA1431 (XRUIInputModule_tA641266A2621C1465F3C5433D747428A4CDA72F0* __this, const RuntimeMethod* method) 
{
	int32_t V_0 = 0;
	{
		...
		V_0 = L_0;
		int32_t L_1 = V_0;
		__this->___m_RollingInteractorIndex_41 = ((int32_t)il2cpp_codegen_add(L_1, 1));
		int32_t L_2 = V_0;
...
IL_001d:
	...
	}
	{
		...
		V_1 = L_11;
		int32_t L_12 = V_1;
		__this->___m_RollingInteractorIndex_41 = ((int32_t)il2cpp_codegen_add(L_12, 1));
		int32_t L_13 = V_1;
...
IL_0057:
	{
		...
		TrackedDeviceModel_t38B1BA171F5602138D487005E134580213B4DBE8* L_13 = (&(&V_2)->___model_1);
		NullCheck(L_12);
		...
		TrackedDeviceModel_t38B1BA171F5602138D487005E134580213B4DBE8* L_14 = (&(&V_2)->___model_1);
		...
		int32_t L_16 = V_1;
		RegisteredInteractor_tE007297C2DFA8EA7A2DFA2CECBF98837726B775E L_17 = V_2;
		NullCheck(L_15);
...
IL_0099:
	{
		...
		bool L_22 = __this->___m_EnableTouchInput_38;
		if (!L_22)
		{
			goto IL_00aa;
		}
	}
	{
		...
		bool L_23;
		L_23 = XRUIInputModule_ProcessTouches_m5803B279A332A189EF841756931CF463879E516C(__this, NULL);
		V_0 = L_23;
	}
...
IL_00aa:
	{
		...
		bool L_24 = __this->___m_EnableMouseInput_37;
		if (!L_24)
		{
			goto IL_00bb;
		}
...
IL_00c9:
	...
	}
	{
		...
		V_9 = L_41;
		int32_t L_42 = V_9;
		__this->___m_RollingInteractorIndex_41 = ((int32_t)il2cpp_codegen_add(L_42, 1));
		int32_t L_43 = V_9;
